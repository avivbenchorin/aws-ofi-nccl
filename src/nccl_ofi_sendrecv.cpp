...
{
	return this->dereg_mr(static_cast<nccl_net_ofi_sendrecv_mr_handle_t *>(base_mr_handle));
}


int nccl_net_ofi_sendrecv_domain_t::dereg_mr(nccl_net_ofi_sendrecv_mr_handle_t *mr_handle)
{
	int ret = 0;
					  ...
					  void **mr_handle)
{
	...
	return this->reg_mr(comm, ckey, type,
			    reinterpret_cast<nccl_net_ofi_sendrecv_mr_handle_t **>(mr_handle));
}


int nccl_net_ofi_sendrecv_domain_t::reg_mr(nccl_net_ofi_comm_t *comm,
					   nccl_ofi_mr_ckey_ref ckey,
					   int type,
					   nccl_net_ofi_sendrecv_mr_handle_t **mr_handle)
{
